...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑职位类型</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>职位类型管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑职位类型</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>职位类型</label>
					<input name="zhiweileixing" id="zhiweileixing" name="zhiweileixing" class="form-control" placeholder="请输入职位类型">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "zhiweileixing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("zhiweileixing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("zhiweileixing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("zhiweileixing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("zhiweileixing"+colName,"GET",{
				tableName: "zhiweileixing",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
		...
		function dataBind(){
			...
			$("#zhiweileixing").val(ruleForm.zhiweileixing);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zhiweileixing != null && res.data.zhiweileixing != ''){
						...
						$("#zhiweileixing").val(res.data.zhiweileixing);
						$("#zhiweileixing").attr('readonly','readonly');
					}
				}
			});  
            }
