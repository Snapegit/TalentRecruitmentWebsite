...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑面试邀请</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>面试邀请管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑面试邀请</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>准备资料</label>
					<textarea  name="zhunbeiziliao" class="form-control textarea" id="zhunbeiziliao" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>面试时间</label>
					<input id="mianshishijian-input" class="date" name="mianshishijian" size="20" type="text" readonly placeholder="请选择面试时间">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "mianshiyaoqing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("mianshiyaoqing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("mianshiyaoqing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("mianshiyaoqing/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#mianshishijian-input").val(getCurDateTime());
			$("#mianshishijian-input").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("mianshiyaoqing"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#zhunbeiziliao").val(ruleForm.zhunbeiziliao);
			$("#mianshishijian-input").val(ruleForm.mianshishijian);
		}		
		//图片显示
		function showImg(){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zhunbeiziliao != null && res.data.zhunbeiziliao != ''){

						$("#zhunbeiziliao").val(res.data.zhunbeiziliao);
					}
					if(res.data != null && res.data != '' && res.data.mianshishijian != null && res.data.mianshishijian != ''){

						$("#mianshishijian-input").val(res.data.mianshishijian);
						$('#mianshishijianFileName').val(res.data.mianshishijian)
					}
				}
			});  
            }
