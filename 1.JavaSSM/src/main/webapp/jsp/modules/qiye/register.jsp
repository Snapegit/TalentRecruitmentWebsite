...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  id="qiyezhanghao" name="qiyezhanghao"  placeholder="请输入企业账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<input  id="qiyemingcheng" name="qiyemingcheng"  placeholder="请输入企业名称" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="fuzeren" name="fuzeren"  placeholder="请输入负责人" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="lianxifangshi" name="lianxifangshi"  placeholder="请输入联系方式" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="youxiang" name="youxiang"  placeholder="请输入邮箱" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="qiyedizhi" name="qiyedizhi"  placeholder="请输入企业地址" class="form-control-i">
				</div>
                <div class="list-item-img">
                    <img id="touxiangImg" src="" width="100" height="100">
                    <div class="upload btn-img">请选择封面<input name="file" type="file" id="touxiangupload" class="form-control-file"></div>
