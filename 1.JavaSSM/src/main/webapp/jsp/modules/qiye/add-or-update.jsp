...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑企业</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>企业管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑企业</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>企业地址</label>
					<input name="qiyedizhi" id="qiyedizhi" name="qiyedizhi" class="form-control" placeholder="请输入企业地址">
				</div>
	...
	<script>
		...
		function dataBind(){
			...
			$("#qiyedizhi").val(ruleForm.qiyedizhi);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.qiyedizhi != null && res.data.qiyedizhi != ''){

						$("#qiyedizhi").val(res.data.qiyedizhi);
						$("#qiyedizhi").attr('readonly','readonly');
					}
