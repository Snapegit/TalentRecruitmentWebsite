...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑参加面试</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>参加面试管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑参加面试</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>面试地点</label>
					<input name="mianshididian" id="mianshididian" name="mianshididian" class="form-control" placeholder="请输入面试地点">
				</div>
				<div class="form-item">
					<label>参加时间</label>
					<input id="canjiashijian-input" class="date" name="canjiashijian" size="20" type="text" readonly placeholder="请选择参加时间">
				</div>
				<div class="form-item">
					<label>企业账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "canjiamianshi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("canjiamianshi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("canjiamianshi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("canjiamianshi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#canjiashijian-input").val(getCurDateTime());
			$("#canjiashijian-input").datetimepicker({ 
				autoclose: true,
		...
		function calculationSE(colName){
			//单列求和接口
			http("canjiamianshi"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#mianshididian").val(ruleForm.mianshididian);	
			$("#canjiashijian-input").val(ruleForm.canjiashijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.mianshididian != null && res.data.mianshididian != ''){

						$("#mianshididian").val(res.data.mianshididian);
						$("#mianshididian").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.canjiashijian != null && res.data.canjiashijian != ''){

						$("#canjiashijian-input").val(res.data.canjiashijian);
						$('#canjiashijianFileName').val(res.data.canjiashijian)
					}
