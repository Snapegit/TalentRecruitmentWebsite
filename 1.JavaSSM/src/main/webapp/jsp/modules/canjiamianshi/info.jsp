...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看参加面试</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看参加面试</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="canjiashijian" name="canjiashijian" class="form-control" v-model="ruleForm.canjiashijian" readonly>
				</div>
				<div class="form-item">
					<label>企业账号</label>
