...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看投递简历</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看投递简历</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item-file">
					...
					<button class="btn-upload btn-file" id="gerenjianli">点击下载</button>
				</div>
				<div class="form-item">
					<label>投递时间</label>

					<input id="toudishijian" name="toudishijian" class="form-control" v-model="ruleForm.toudishijian" readonly>
				</div>
				<div class="form-item">
					<label>企业账号</label>
