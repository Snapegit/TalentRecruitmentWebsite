...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑投递简历</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>投递简历管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑投递简历</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>性别</label>
					<input name="xingbie" id="xingbie" name="xingbie" class="form-control" placeholder="请输入性别">
				</div>
				<div class="form-item">
					<label>手机</label>
				...
				<div class="form-item-file">
					<label>个人简历</label>
					<div class="upload btn-file">选择文件<input name="file" type="file" class="form-control-file" id="gerenjianliupload"></div>
					<div id="gerenjianliFileName" class="text"></div>
					<input name="gerenjianli" id="gerenjianli-input" type="hidden">
				</div>
				<div class="form-item">
					<label>投递时间</label>
					<input id="toudishijian-input" class="date" name="toudishijian" size="20" type="text" readonly placeholder="请选择投递时间">
				</div>
				<div class="form-item">
					<label>企业账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "toudijianli/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("toudijianli/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("toudijianli/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("toudijianli/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#toudishijian-input").val(getCurDateTime());
			$("#toudishijian-input").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#toudishijian-input").val(ruleForm.toudishijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.toudishijian != null && res.data.toudishijian != ''){

						$("#toudishijian-input").val(res.data.toudishijian);
						$('#toudishijianFileName').val(res.data.toudishijian)
					}
