...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<input  id="shouji" name="shouji"  placeholder="请输入手机" class="form-control-i">
				</div>
				<div class="list-item">
					<input  id="shenfenzheng" name="shenfenzheng"  placeholder="请输入身份证" class="form-control-i">
				</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "qiuzhizhe/register";
				$.ajax({ 
					type: "POST",
					url: url,
