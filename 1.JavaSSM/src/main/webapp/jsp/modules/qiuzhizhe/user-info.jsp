...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑求职者</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>求职者管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑求职者</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>账号</label>
					<input name="zhanghao" readonly id="zhanghao" name="zhanghao" class="form-control" placeholder="请输入账号">
				</div>
				<div class="form-item">
					<label>姓名</label>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("qiuzhizhe/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("qiuzhizhe/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
