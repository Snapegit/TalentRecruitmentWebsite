...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">咨询企业管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>咨询企业列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>咨询标题</label>
					<input type="text" id="zixunbiaotiSearch" class="form-control form-control-sm" placeholder="请输入咨询标题" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>企业名称</label>
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('zixunbiaoti')">咨询标题<i id="zixunbiaotiIcon" class="fa fa-sort"></i></th>
						<th onclick="sort('zixunshijian')">咨询时间<i id="zixunshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zixunwentiCell  = document.createElement('td');

			
			var zixunshijianCell  = document.createElement('td');

						  zixunshijianCell.innerHTML = item.zixunshijian;


			row.appendChild(zixunshijianCell);
		...
		function sh(){
			...
			httpJson("zixunqiye/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("zixunqiye/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"zixunqiye");
