...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑公告信息</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>公告信息管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑公告信息</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>简介</label>
					<textarea  name="jianjie" class="form-control textarea" id="jianjie" rows="3"></textarea>
				</div>
				<div class="form-item">
					<label>发布时间</label>
