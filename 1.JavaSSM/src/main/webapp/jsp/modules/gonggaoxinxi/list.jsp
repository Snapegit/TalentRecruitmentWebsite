...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">公告信息管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>公告信息列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				...
				<div class="form-item">
					<label>简介</label>
					<input type="text" id="jianjieSearch" class="form-control form-control-sm" placeholder="请输入简介" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			...
			if($('#jianjieSearch').val() != null && $('#jianjieSearch').val() != ''){
				searchForm.jianjie ="%" +  $('#jianjieSearch').val() + "%";
			}
