				...
				<div :style='{"padding":"0px","margin":"0","borderColor":"#2286bc","background":"none","borderWidth":"0px","flex":"1","width":"100%","borderStyle":"solid"}' class="right-container">
					<form :style='{"padding":"60px 0px 30px","boxShadow":"0px 0px 0px #eee","borderColor":"#eee","margin":"40px 0 0","display":"flex","justifyContent":"space-between","borderRadius":"0","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230127/26adbfa03b974a4b8b465c121356adec.png) no-repeat left top,#fff","borderWidth":"0px","width":"100%","borderStyle":"solid","height":"auto"}' class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">账号</label>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">姓名</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="xingming" name="xingming" id="xingming" placeholder="姓名" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">手机</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="shouji" name="shouji" id="shouji" placeholder="手机" autocomplete="off" class="layui-input">
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","margin":"0 0 10px 0","borderColor":"#c6ecc6","alignItems":"center","background":"none","borderWidth":"0px","display":"flex","width":"48%","borderStyle":"solid"}'>
							<label :style='{"width":"150px","padding":"0 15px","lineHeight":"40px","fontSize":"16px","color":"#2286bc","textAlign":"right"}' class="layui-form-label">身份证</label>
							<input :style='{"padding":"0 10px","margin":"0","borderColor":"#ddd","color":"#333","outline":"none","borderRadius":"30px","borderWidth":"1px","background":"none","width":"360px","fontSize":"14px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' type="text"  name="shenfenzheng" name="shenfenzheng" id="shenfenzheng" placeholder="身份证" autocomplete="off" class="layui-input">
						</div>
