	...
	<body>
		<div id="register" class="register" :style='{"minHeight":"100vh","padding":"0","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230128/effb535f5a6142daa256f40fb8542933.jpg) no-repeat center bottom / 100% 100%,#fff","display":"flex","width":"100%","justifyContent":"flex-start"}'>
			<form id="registerForm" class="layui-form login-form" :style='{"padding":"20px 0px 40px","boxShadow":"0 0px 0px rgba(0, 0, 0, .1)","margin":"20px 0 0 12%","borderColor":"#eee","display":"flex","justifyContent":"center","minHeight":"550px","outline":"0px solid #eee","borderRadius":"0","outlineOffset":"0px","flexWrap":"wrap","background":"rgba(255,255,255,1)","borderWidth":"0px","width":"44%","borderStyle":"solid","height":"100%"}' lay-filter="myForm">
				...
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>企业名称：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#ddd","color":"#333","borderRadius":"8px","borderWidth":"2px","background":"none","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="qiyemingcheng" name="qiyemingcheng" placeholder="请输入企业名称" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>负责人：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#ddd","color":"#333","borderRadius":"8px","borderWidth":"2px","background":"none","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="fuzeren" name="fuzeren" placeholder="请输入负责人" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
				...
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					...
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#ddd","color":"#333","borderRadius":"8px","borderWidth":"2px","background":"none","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="youxiang" name="youxiang" placeholder="请输入邮箱" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>企业地址：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#ddd","color":"#333","borderRadius":"8px","borderWidth":"2px","background":"none","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="qiyedizhi" name="qiyedizhi" placeholder="请输入企业地址" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","height":"auto"}' class="form-item">
					<div v-if="false" :style='{"width":"64px","lineHeight":"40px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>封面：</div>
