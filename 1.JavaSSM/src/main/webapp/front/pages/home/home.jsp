			...
			<div :style='{"padding":"0","margin":"10px auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between"}'>
				...
				<div class="recommends" :style='{"padding":"20px 0 30px","margin":"0","borderColor":"#eee","flexWrap":"wrap","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230127/cb48feb1ff1b497faa783e042fab17b3.jpg) repeat-y center top / 100% 100%","borderWidth":"0px","display":"block","width":"100%","position":"relative","borderStyle":"solid","order":"4"}'>
					...
					<div class="title" :style='{"padding":"0px 0 30px","margin":"60px auto 40px","borderColor":"#f6cccc","alignItems":"center","textAlign":"left","flexDirection":"initial","display":"flex","justifyContent":"center","minHeight":"50px","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20230127/08c16dc8bbc641d9b10f2c8403aeb7f1.png) no-repeat center bottom","borderWidth":"0px","width":"100%","borderStyle":"dashed"}'>
						...
						<span :style='{"padding":"0 0px","margin":"0px","color":"#fff","textAlign":"center","background":"none","width":"auto","fontSize":"30px","lineHeight":"50px"}'>招聘信息推荐</span>
					</div>
				    ...
				    <div :style='{"padding":"0px 7%","margin":"20px 0 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}' class="list list-2">
						<div :style='{"cursor":"pointer","padding":"10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"0 0 30px","borderColor":"#eee","display":"flex","justifyContent":"space-between","flexWrap":"wrap","background":"#fff","borderWidth":"0px","width":"23.5%","fontSize":"0","position":"relative","borderStyle":"solid","height":"auto"}' class="list-item animation-box" v-for="(item,index) in zhaopinxinxiRecommend" :key="index" @click="jump('../zhaopinxinxi/detail.jsp?id='+item.id)">
							<img :style='{"verticalAlign":"middle","padding":"10px","borderColor":"#ccc","objectFit":"contain","borderRadius":"0","borderWidth":"0px","background":"none","display":"inline-block","width":"100%","borderStyle":"dashed","height":"380px"}' :src="item.fengmian?baseurl+item.fengmian.split(',')[0]:''" alt="" />
							<div :style='{"width":"calc(100% - 0px)","padding":"0","verticalAlign":"middle","overflow":"hidden","display":"inline-block","height":"100%"}' class="item-info">
								<div :style='{"padding":"0","borderColor":"#eee","margin":"0 0 5px","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderWidth":"0px","background":"none","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis","borderStyle":"solid","fontWeight":"500","height":"24px"}' class="name">{{item.zhiweimingcheng}}</div>
								<div :style='{"padding":"0","borderColor":"#eee","margin":"0 0 5px","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderWidth":"0px","background":"none","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis","borderStyle":"solid","fontWeight":"500","height":"24px"}' class="name">{{item.zhiweileixing}}</div>
								<div :style='{"padding":"0","borderColor":"#eee","margin":"0 0 5px","whiteSpace":"nowrap","color":"#333","textAlign":"center","overflow":"hidden","borderWidth":"0px","background":"none","width":"100%","lineHeight":"24px","fontSize":"16px","textOverflow":"ellipsis","borderStyle":"solid","fontWeight":"500","height":"24px"}' class="name">{{item.qiyemingcheng}}</div>
							</div>
				        </div>
				    </div>

					<div :style='{"cursor":"pointer","padding":"0 20px","margin":"10px auto","borderColor":"#f65602","borderRadius":"30px","textAlign":"center","background":"none","borderWidth":"0px","display":"inline-block","width":"auto","lineHeight":"40px","borderStyle":"dashed"}' @click="jump('../zhaopinxinxi/list.jsp')">
						...
						<div :style='{"width":"100%","padding":"50px 10px","margin":"40px 0 0","background":"none"}' id="lists-five-swipergonggaoxinxi" class="swiper-container lists-five-swiper">
							<div class="swiper-wrapper">
								<div :style='{"border":"0","padding":"20px","fontSize":"0","position":"relative","borderRadius":"4px","background":"none"}' class="swiper-slide" v-for="(item,index) in gonggaoxinxiList" :key="index" @click="jump('../gonggaoxinxi/detail.jsp?id='+item.id)">
									<img :style='{"border":"0","width":"200px","padding":"30px 20px","objectFit":"contain","background":"url(http://codegen.caihongy.cn/20230128/d927f93371f746899f81fd3ae78502d1.png) no-repeat center top / 100% 100%,#fff","height":"220px"}' :src="item.fengmian?baseurl+item.fengmian.split(',')[0]:''" alt="" />
								</div>
							</div>
														<!-- Add Arrows -->
