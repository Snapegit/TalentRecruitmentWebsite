				...
				<div :style='{"padding":"0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","margin":"0","display":"flex","justifyContent":"space-between","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","position":"relative","borderStyle":"solid"}'>
					...
					<div :style='{"minHeight":"540px","padding":"0 0 40px","margin":"20px 7% 0","borderColor":"#eee","background":"url(http://codegen.caihongy.cn/20230127/03ad723288d44044a8b922de0a51127f.png) no-repeat left top,url(http://codegen.caihongy.cn/20230127/e1b074885e304a40bcfa7de91c22b700.png) no-repeat center bottom,#e0edf2","borderWidth":"0px","flex":"1","width":"100%","borderStyle":"solid","order":"1"}'>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"18px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>账号：</div>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"18px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>性别：</div>
							<div  :style='{"padding":"8px 10px 0","wordBreak":"break-all","color":"#333","background":"none","width":"100%","fontSize":"16px","lineHeight":"24px"}' class="desc">
								{{detail.xingbie}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"18px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>手机：</div>
							<div  :style='{"padding":"8px 10px 0","wordBreak":"break-all","color":"#333","background":"none","width":"100%","fontSize":"16px","lineHeight":"24px"}' class="desc">
								{{detail.shouji}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"18px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>职位名称：</div>
							<div  :style='{"padding":"8px 10px 0","wordBreak":"break-all","color":"#333","background":"none","width":"100%","fontSize":"16px","lineHeight":"24px"}' class="desc">
								{{detail.zhiweimingcheng}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"18px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>投递时间：</div>
							<div  :style='{"padding":"8px 10px 0","wordBreak":"break-all","color":"#333","background":"none","width":"100%","fontSize":"16px","lineHeight":"24px"}' class="desc">
								{{detail.toudishijian}}
							</div>
						</div>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","whiteSpace":"nowrap","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"18px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>个人简历：</div>
							<a :style='{"padding":"0px 10px","margin":"0px 0 0","borderColor":"#ddd","color":"#333","textAlign":"center","textDecoration":"none","borderRadius":"20px","background":"#fff","borderWidth":"1px","width":"100px","lineHeight":"36px","fontSize":"16px","borderStyle":"solid","height":"36px"}' download="gerenjianli" :href="baseurl+detail.gerenjianli">点击下载</a>
						</div>
						<div class="detail-item" :style='{"padding":"10px 7%","flexWrap":"wrap","background":"none","display":"flex"}'>


							<button :style='{"border":"0px solid #b8d7f2","cursor":"pointer","padding":"0 10px","margin":"0 5px 0px 0","outline":"none","color":"#333","borderRadius":"4px","background":"#b9f4e3","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' v-if="isAuth('toudijianli','面试邀请')" @click="onAcrossTap('mianshiyaoqing','','')" type="button" class="layui-btn">
								面试邀请
							</button>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`toudijianli`);
