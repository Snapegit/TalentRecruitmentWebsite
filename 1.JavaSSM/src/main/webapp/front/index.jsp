...
<html>
	<head>
		...
		<title>基于JSP的人才招聘网站的设计与实现</title>
	...
	<div id="apps">
		<div id="header" :style='{"padding":"0px","margin":"0 auto","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"#333","width":"100%","position":"relative","height":"44px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"margin":"0 0 0 180px","color":"#fff","textAlign":"center","background":"none","width":"calc(100% - 360px)","lineHeight":"44px","fontSize":"18px","height":"44px"}' class="nav-top-title">{{projectName}}</div>
